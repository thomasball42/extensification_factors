...
in _stats.py) fixes the overfitting signature found by
...
from _holdout_common import load_wide, load_groups
from extensification_factors.validation.holdout_comparison import run_holdout_comparison
...
CANDIDATES = [
    ...
    {"label": "str_0.9_scale_0.03", "q_prior_scale": 0.03, "q_prior_strength": 0.9},
    {"label": "str_0.9_scale_0.02", "q_prior_scale": 0.02, "q_prior_strength": 0.9},
    {"label": "str_0.9_scale_0.01", "q_prior_scale": 0.01, "q_prior_strength": 0.9},
